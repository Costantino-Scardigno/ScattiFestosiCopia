...
const SharedAlbumView = () => {
  ...
  return (
    <div className="container-fluid py-4 bg-light-custom">
      ...
      {selectedPhoto && (
        <div
          ...
          style={{ display: "block", backgroundColor: "rgba(53, 34, 8, 0.8)" }}
          onClick={closePhoto}
        >
          <button
            type="button"
          ...
          >
            <div className="modal-content border-0 bg-transparent">
              ...
              <div className="modal-footer bg-white-custom rounded-bottom">
